...
static void set_lines(void)
{
	...
	create_line_vao(0, 1.0f - M_W + d_x, y1, g_str_xlogins[0]->image_width + 20);
	g_lines[0].color = vec4(0.850980392156863f, 0.325490196078431f, 0.309803921568627f, 0.0f);
	create_line_vao(1, 1.0f - M_W + d_x * 2, y1, g_str_xlogins[1]->image_width + 20);
	g_lines[1].color = vec4(1.0f, 0.654901960784314f, 0.0f, 0.0f);
	create_line_vao(2, 1.0f - M_W + d_x * 3, y1, g_str_xlogins[2]->image_width + 20);
	g_lines[2].color = vec4(0.36078431372549f, 0.72156862745098f, 0.36078431372549f, 0.0f);
	create_line_vao(3, 1.0f - M_W + d_x * 4, y1, g_str_xlogins[3]->image_width + 20);
